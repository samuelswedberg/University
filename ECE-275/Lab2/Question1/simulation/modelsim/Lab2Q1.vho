...
-- Design Ports Information
-- f	=>  Location: PIN_E22,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF Lab2Q1 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \f~0_combout\ = (\c~input_o\ & (((\d~input_o\ & !\b~input_o\)) # (!\a~input_o\))) # (!\c~input_o\ & (\d~input_o\ & (!\b~input_o\ & !\a~input_o\)))
